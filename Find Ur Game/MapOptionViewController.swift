...
class MapOptionViewController: UIViewController,CLLocationManagerDelegate,MKMapViewDelegate {
    ...
    func addLongPressGesture(){
        let longPressRecogniser:UILongPressGestureRecognizer = UILongPressGestureRecognizer(target:self , action:#selector(MapOptionViewController.handleLongPress(_:)))
    ...
    @IBAction func getMyLocation(sender: UIButton) {
        ...
        if CLLocationManager.locationServicesEnabled() {
            if MapOptionViewController.enable {
            ...
            MapOptionViewController.enable = !MapOptionViewController.enable
        }
    }
